...
if selection == "Accueil":
    ...
    st.image("/Users/lou/Documents/GitHub/projet2_AAA/bd_ignore/medias/logo_canape.jpeg", width=500)
    st.write("""
                ...
                if selected_title:
                    ...
                    if 'imdb_id_x' in selected_movie.columns and 'poster_path' in selected_movie.columns:
                        ...
                        if poster_path:
                            ...
                            st.image("/Users/lou/Documents/GitHub/projet2_AAA/bd_ignore/medias/affiche.jpeg", width=150, caption="Affiche non disponible")
                    else:
                            ...
                            if idx < nb_films:
                                ...
                                with cols[col]:
                                    if pd.notna(film['poster_path']):
                                        ...
                                        st.image("/Users/lou/Documents/GitHub/projet2_AAA/bd_ignore/medias/affiche.jpeg", 
                                            width=150, 
                                            caption=film['title'])
        ...
        for idx, res in resultats.iterrows():
            ...
            with col_courante:
                if pd.notna(poster_path):
                    ...
                    st.image("/Users/lou/Documents/GitHub/projet2_AAA/bd_ignore/medias/affiche.jpeg", width=150, caption=title)
...
# Page KPI
    ...
    st.title("KPI")
    try:
      df_final_KPI = pd.read_csv("/Users/lou/Documents/GitHub/projet2_AAA/bd_ignore/resultat/df_final.csv")
      df_top5_act_films = pd.read_csv("/Users/lou/Documents/GitHub/projet2_AAA/bd_ignore/resultat/df_top5_act_films.csv")  #graph de top5 acteurs avec leurs projets les plus connus (vient de df_final_re)
      age_moyen1 = pd.read_csv("/Users/lou/Documents/GitHub/projet2_AAA/bd_ignore/resultat/age_moyen.csv") #graph âge moyen par période
      df_best_movies = pd.read_csv("/Users/lou/Documents/GitHub/projet2_AAA/bd_ignore/resultat/df_best_movies.csv")
      comparaison_FSduree =  pd.read_csv("/Users/lou/Documents/GitHub/projet2_AAA/bd_ignore/resultat/comparaison_FSa.csv")
    ...
    #   df_best_movies = df_best_movies.style.format({"year": lambda x : '{:.0f}'.format(x)}) #permet de supprimer la virgule qui se met par défaut dans la colonne année
      ...
      st.image("/Users/lou/Documents/GitHub/projet2_AAA/bd_ignore/medias/top3.png", width=700)  
      st.image("/Users/lou/Documents/GitHub/projet2_AAA/bd_ignore/medias/tableau_podium.png", width=700)       
